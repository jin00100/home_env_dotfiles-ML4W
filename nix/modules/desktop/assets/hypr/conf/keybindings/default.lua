...
hl.bind(mainMod .. " + SHIFT + RETURN", hl.dsp.exec_cmd("~/.config/kitty/launch.sh"), { description = "Open OSYX Kitty terminal" })
...
for i = 1, 10 do
    ...
    hl.bind(mainMod .. " + " .. key,             hl.dsp.focus({ workspace = tostring(i)}), { description = "Focus workspace " .. i })
...
hl.bind(mainMod .. " + CTRL + M", hl.dsp.exec_cmd("~/.config/hypr/scripts/select-resolution.sh"), { description = "Select monitor resolution" })
...
hl.bind("CTRL + SHIFT + A", hl.dsp.exec_cmd("~/.config/hypr/scripts/screenshot.sh --instant-area"), { description = "Take an instant area screenshot" })
...
hl.bind(mainMod .. " + space", hl.dsp.exec_cmd("~/.config/hypr/scripts/launcher.sh"), { description = "Open application launcher (Mac style)" })

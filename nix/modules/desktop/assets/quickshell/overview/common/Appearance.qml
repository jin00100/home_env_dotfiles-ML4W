...
Singleton {
    ...
    property QtObject defaultColors: QtObject {
        ...
        property color m3primary: "#42DDF5"
        property color m3onPrimary: "#003640"
        property color m3primaryContainer: "#104B59"
        property color m3onPrimaryContainer: "#B9F4FF"
        property color m3secondary: "#A970FF"
        property color m3onSecondary: "#27005B"
        property color m3secondaryContainer: "#352052"
        property color m3onSecondaryContainer: "#EADBFF"
        property color m3background: "#050609"
        property color m3onBackground: "#E5E7EF"
        property color m3surface: "#050609"
        property color m3surfaceContainerLow: "#0C0E14"
        property color m3surfaceContainer: "#12151E"
        property color m3surfaceContainerHigh: "#1A1E29"
        property color m3surfaceContainerHighest: "#242938"
        property color m3onSurface: "#E5E7EF"
        property color m3surfaceVariant: "#353B4C"
        property color m3onSurfaceVariant: "#BDC3D2"
        property color m3inverseSurface: "#E5E7EF"
        property color m3inverseOnSurface: "#292E3A"
        property color m3outline: "#66708A"
        property color m3outlineVariant: "#353B4C"
